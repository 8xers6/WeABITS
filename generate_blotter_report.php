                            ...
                            <div class="card">
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <h2 class="fw-bold ">Barangay <?= ucwords($brgy) ?>, <?= ucwords($town) ?>,<?= ucwords($province) ?>   </h2>
                                                ...
                                                <div class="col">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8" style="border-bottom:1px solid black; margin:0 !important">
                                                            <span class="fw-bold" style="font-size:20px;"><?= ucwords($resident['lastname'].', '.$resident['firstname'].' '.$resident['middlename']) ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 d-flex flex-wrap justify-content-end">
                                            <div class="p-3 text-center">
                                                ...
                                                <h2 class="fw-bold mb-0"><?= ucwords($resident['lastname'].', '.$resident['firstname'].' '.$resident['middlename']) ?></h2>
