<?php 
    ...
    if(!empty($barno) && !empty($medicine)){
        ...
        if($result === true){
            $_SESSION['message'] = 'Expired Medicine Updated!';
  ...
  $username=$_SESSION['username'];
        $insert  = "INSERT INTO `tblaudit_trail`(`bar_no`, `log_id`, `audit_username`, `audit_action`) VALUES ('$barno','0','$username','Updated Expired Medicine')";
        $result  = $conn->query($insert);
