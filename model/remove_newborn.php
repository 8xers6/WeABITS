<?php 
	...
	if($id != ''){
		$query 		= "DELETE FROM `tblchildren` WHERE `child_id`='$id'";
  ...
  $username=$_SESSION['username'];
        $insert  = "INSERT INTO `tblaudit_trail`(`bar_no`, `log_id`, `audit_username`, `audit_action`) VALUES ('$barno','0','$username','Remove Newborn')";
