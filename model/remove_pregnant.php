<?php 
	...
	if($pregno != ''){
		$query 		= "DELETE FROM `tblpregnant` WHERE `preg_no`='$pregno'";
  ...
  $username=$_SESSION['username'];
        $insert  = "INSERT INTO `tblaudit_trail`(`bar_no`, `log_id`, `audit_username`, `audit_action`) VALUES ('$barno','0','$username','Remove Pregnant')";
