...
$barno=$_SESSION['bar_no'];
	...
	$query1 = "UPDATE tblbarangay SET  `personel`='1'  WHERE bar_no=$barno;";
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold">Set Up Certificates</h2>
							</div>
						</div>
										...
										<div class="card-tools">
											...
											<a href="#add" data-toggle="modal" class="btn btn-info btn-border btn-round btn-sm">
												...
												Certificate  
													...
													<a type="button" href="getequip" class="ml-3 btn btn-primary text-white fw-bold" onclick="return confirm('Are you sure you want to proceed?');">Next</a>
										</div>
									</div>
								</div>
								<div class="card-body" >
