...
<head>
	...
	<title>Check Out -  Barangay Management System</title>
...
<!----
								   <div class="col-md-11 m-0 pb-2 border rounded shadow-sm">
							
								  <h3><b>Payment Method:</b></h3>
								  <div class="col-md-11 m-0 pb-2  ">
								  <input type="radio" name="demo"  value=""/><b> G-Cash</b><br>
						          </div>

								  
								  <div class="col-md-11 m-0 pb-2 ">
								  <input type="radio" name="demo"   value="Two"/><b>Cash on Pick up</b>
						</div>
					 ...
					 <div class="col-md-11 m-1 pb-2 border rounded shadow-sm">
							<h3><b>Gcash Reference No.:(for Gcash payment Only)</b></h3>
					
							
                                         <input type="text" class="form-control"value="" placeholder="Enter Gcash Reference no." name="amount"  >
					 ...
					 <select class="form-control"  name="dt" required >
											 ...
											 <option value="Gcash">Digital Copy</option>
											 <option value="cash-on-pickup">Hard Copy</option>
