...
<div class="" id="send" style="display:block;">


<h3 class="text-center">Verify Email</h3>

<label for="email" class="fw-bold">Enter your Email Address</label>
<span role="alert" id="email_error" aria-hidden="true" style="color:red; font-size:15px;"> Email can't be empty </span>
<span role="alert" id="email_valid" aria-hidden="true" style="color:red; font-size:15px;"> Invalid Email </span>

					<input  id="emailadd" type="email" class="form-control" required>
					
				
                <div class="form-action mb-3">
				<button  class="btn btn-primary fw-bold pl-5 pr-5"  id="btnsend">Send OTP</button>
...
<input
    ...
    <?php include 'validationform.php' ?>
...
function previewID() {
const preview = document.querySelector('.idphoto');



const file = document.querySelector('.validphoto').files[0];
...
const  bill= document.getElementById("billingadd");
...
const preview = document.querySelector('.billphoto');



const file = document.querySelector('.billingphoto').files[0];
const reader = new FileReader();
...
var modal = document.getElementById("view");
      ...
      if($.trim(response)=='emptyid'){
         document.getElementById("btnsub").style.display = "block";
  document.getElementById("ssloading").style.display = "none";
          $('#checkerrors').html('<b style="color:red;">Attach Valid ID!</b>');
       ...
       if($.trim(response)=='emptybill'){
         document.getElementById("btnsub").style.display = "block";
  document.getElementById("ssloading").style.display = "none";
          $('#checkerrors').html('<b style="color:red;">Attach Billing Address!</b>');
       ...
       if($.trim(response)=='success'){
           //document.getElementById("btnsub").style.display = "none";
  //document.getElementById("ssloading").style.display = "none";
       $('#login_form').html('<div class="col-md-12 rounded p-3 m-3 bg-success "><h3 class="text-white" >Registration Submitted</h3></div>');
...
var modal = document.getElementById("view");
        ...
        if($.trim(response)=='success'){
          document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera
          window.location.pathname = ('/resident/register')
