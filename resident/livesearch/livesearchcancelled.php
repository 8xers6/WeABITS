...
if(!empty($_POST['live_search_cancel'])){

$search=$_POST['live_search_cancel'];
     ...
     $borno=$row['bor_no'];
         ...
         $dtoborrow = date('F j, Y', strtotime($datetoborrow));
            ...
            <!---<div  class="row   justify-content-center p-2  ml-0  mr-0  text-white fw-bold rounded bg-danger-gradient">Borrow No.'.$borno.'<span class="badge  badge-danger  fw-bold">Pending</span></div> ----> <div class="row justify-content-center ">
                           <img src="../assets/uploads/'.$busername.'/equipment/'.$image.'" height="200" width="290" alt="Responsive image" style="width:290px; border-radius:20px;  filter: grayscale(100%);">
                           
                           
                           
                                <h4 class="mr-5 text-link"><b>'.$itemname.' </b>    </h4>    
                      
                       
                                
                       
                         <h4 class="ml-5 text-link">Qty:'.$qty.'</h4> 
           </div> 
    ...
    $result1 = $conn->query($query1);
     ...
     $borno=$row['bor_no'];
         ...
         $dtoborrow = date('F j, Y', strtotime($datetoborrow));
            ...
            <!---<div  class="row   justify-content-center p-2  ml-0  mr-0  text-white fw-bold rounded bg-danger-gradient">Borrow No.'.$borno.'<span class="badge  badge-danger  fw-bold">Pending</span></div> ----> <div class="row justify-content-center ">
                           <img src="../assets/uploads/'.$busername.'/equipment/'.$image.'" height="200" width="290" alt="Responsive image" style="width:290px; border-radius:20px;  filter: grayscale(80%);">
