<?php 
	...
	if(!empty($email)&& !empty($emailtoken)){
        ...
        $verify_query="SELECT email_token,email FROM tbl_residents WHERE  email_token='$emailtoken' AND email='$email' LIMIT 1";
                            ...
                            <li>password must include atleast one special character.</li>
                                ...
                                if($new_pass==$con_pass){
                                    ...
                                    $token=md5(rand(1,1000));
                                        ...
                                        $query 		= "UPDATE tbl_residents SET `password`='$hash',email_token='$token' WHERE email='$email'";	
