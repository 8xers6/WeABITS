...
<?php include 'templates/loading_screen.php' ?>
                            ...
                            <div class="card">
                               ...
                               <!--- <img src="assets/img/green.png"  style="position:absolute;   height:300px; width:100%;  opacity:0.1;"> --->  
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col " style=" position: relative; top:-10px; border-left:solid black 3px; height:1200px;">
                                            <div class="text-center">
                                            ...
                                            <div class="text-center" >
                                                <h1 class="fw-bold mt-3" style="font-size:50px; color:black; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; ">BARANGAY CLEARANCE</h1>

                                                
                                            	<?php if(!empty($resident['resident_image'])): ?>
  
  <img src="<?= preg_match('/data:image/i', $resident['resident_image']) ?  $resident['resident_image'] : "assets/uploads/".$_SESSION['username']."/resident/".$resident['res_id']."/". $resident['resident_image'] ?>" alt="..." class="avatar-img rounded border shadow-sm"  style="position: relative;  width:200px; height:200px; border-radius:50px;">
  ...
  <?php endif ?> 
                                       ...
                                       <br><br><br><br><br>
                                            ...
                                            <span class="fw-bold" style="font-size:25px"><?= ucwords($resident['household_no']) ?>  <?= ucwords($resident['streetname']) ?>  <?= ucwords($barangayname) ?>,   <?= ucwords($city) ?> , <?= ucwords($province) ?></span> and born in <span class="fw-bold ml-1 mr-1" style="font-size:25px"> <?= ucwords($resident['birthplace'])?></span> that he/she is a good citizen and has no civil or criminal charges against this office.</h3>
                                            ...
                                            <?php $str = $resident['date_issued']; $date = date('F j, Y', strtotime($str)); echo $date; ?></span>   in Barangay <span class="fw-bold" style="font-size:25px"> <?= ucwords($barangayname) ?>,   <?= ucwords($city) ?> , <?= ucwords($province) ?> </span>to use on  <span class="fw-bold" style="font-size:25px"><?= ucwords($resident['purpose'])?></span> .</p>
 ...
 <br><br><br>
                                        ...
                                        <div class="row m-0 p-1 "style="position:relative; top:20px; color:black;   ">
                                            ...
                                            <div class=" col-3 mt-4 " style="pointer-events: none;">
