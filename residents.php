                                                       ...
                                                       <?= ucwords($row['lastname'].', '.$row['firstname'].' '.$row['middlename']) ?>
														...
														<td>
															<div class="form-button-action">
                                                                ...
                                                                <a type="button" data-toggle="tooltip" href="model/remove_residents.php?id=<?= $row['res_id'] ?>" onclick="return confirm('Are you sure you want to delete this resident?');" class="btn btn-link btn-danger" data-original-title="Remove">
...
<option value="Not Applicable">Not Applicable</option>
  ...
  <option value="Sensory Disabilities">Sensory Disabilities</option>
                                                  ...
                                                  <input type="number" class="form-control" placeholder="Enter Contact Number" name="contact_no" id="number">
             ...
             <div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/import.php"  enctype="multipart/form-data">
              ...
              <div class="modal fade" id="export" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/export_residents_csv.php"  enctype="multipart/form-data">
