	...
	<div class="wrapper">
      ...
      <div class="panel-header bg-primary-gradient">
					<div class="page-inner">
                    	...
                    	<h2 class="text-white fw-bold">Maintenance -Medicine</h2>
							<div>
           ...
           <!-- Modal -->
                    ...
                    <?php if(isset($_SESSION['message'])): ?>
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Expired Medicine</div>
										<div class="card-tools">
                                            <!----
											<a href="#addexp" data-toggle="modal" class="btn btn-info btn-border btn-round btn-sm">
												<i class="fa fa-plus"></i>
												Expired Medicine
											</a>--->
										</div>
                                        ...
                                        <table class="table table-striped" id="expired">
                                            ...
                                            <tbody>
                                                <?php if(!empty($expired)): ?>
                                                    <?php $no=1; foreach($expired as $row): ?>
                                                    <tr>
                                                    <form method="POST" action="model/remove_medicine.php" >
                                                        <td>
                                                            
                                                        
                                                        <input type="hidden" value="delexp" class="form-control"  name="state" required>
                                                        ...
                                                        <?= $row['date_expired'] ?></td>
                                                        <td>
                                                        <button type="submit" class="text-danger btn"  onclick="return confirm('Are you sure you want to Proceed?');">  <i class="fa fa-times"></i></button>
