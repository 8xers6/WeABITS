...
$query = "SELECT `res_id`, `bar_no`, `h_no`, `firstname`, `lastname`, `middlename`, `suffix`, `civil_status`, `gender`, `relation`  FROM `tbl_residents` WHERE  `bar_no`= $barno AND `h_no`=$hno AND `res_id` Not in ('$resid')";
