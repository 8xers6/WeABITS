			...
			<div class="">
				<div class=" bg-primary-gradient">
					<div class="page-inner">
						<div class="">
							<div>
								<h2 class="text-white fw-bold">Set Up Street</h2>
							</div>
								...
								<div class="card-header">
									<div class="card-head-row">
										...
										<div class="card-tools">
											...
											<a type="button" href="getchairman" class="ml-3 btn btn-primary text-white fw-bold" onclick="return confirm('Are you sure you want to proceed?');">Next</a>
										</div>
									</div>
								</div>
								<div class="card-body">
